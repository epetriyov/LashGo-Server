...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/resources/js/handlebars-1.0.0.beta.6.js'/>" context="/lashgodoc"></script>
    <script type="text/javascript" src="<c:url value='/resources/js/bootstrap.min.js'/>"  context="/lashgodoc"></script>
    <script type="text/javascript" src="<c:url value='/resources/js/jlinq.js'/>" context="/lashgodoc"></script>
    <script type="text/javascript" src="<c:url value='/resources/js/prettify.js'/>" context="/lashgodoc"></script>
    <script src="<c:url value='/resources/js/bootstrap-button.js'/>" context="/lashgodoc"></script>

    <!-- Le styles -->
    <link href="<c:url value='/resources/css/bootstrap.min.css'/>" context="/lashgodoc" rel="stylesheet">
    <link href="<c:url value='/resources/css/font-awesome.css'/>" context="/lashgodoc" rel="stylesheet">
    <style type="text/css">
        body {
            padding-top: 60px;
            padding-bottom: 40px;
    ...
    <link href="<c:url value='/resources/css/bootstrap-responsive.min.css'/>" context="/lashgodoc" rel="stylesheet">
